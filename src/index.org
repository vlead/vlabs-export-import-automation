...
class ImportLab(unittest.TestCase):
    ...
    def test_import_lab(self):
        ...
        driver.get(self.base_url + "/course/course-v1:Virtual-Labs+hmt03+Anytime")
#        driver.find_element_by_xpath("//div[@id='content']/div[2]/section/article/div[3]/ul/li[31]/a/h3").click()
        ...
        time.sleep(10)
        driver.find_element_by_css_selector("input[type=file]").send_keys('/home/virtual-labs/projects/open-edx-FAB-laboratory-coep.tar.gz')
        time.sleep(10)
